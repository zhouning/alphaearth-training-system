...
- Confirm that `review_audit_summary.json` remains schema version 2 and includes model-scope, label-source, and decoder-capacity checks before upload.
